					...
					<div class="accordion-item">
						...
						<div id="flush-collapse1" class="accordion-collapse collapse" aria-labelledby="flush-heading1" data-bs-parent="#accordionFlushFAQ">
							<div class="accordion-body">
								<p>▷ 색상/사이즈 및 배송지 변경 결제완료 단계일때 마이페이지에서 직접 수정하실 수 있습니다. 주문이 상품준비중 단계로 변경된 이후에는 1:1 고객상담을 통해 변경 신청 하실 수 있습니다. ▷ 주문 취소 마이페이지 주문상세 내역에서 즉시 취소가 가능한 단계는 아래와 같습니다. - 신용카드 주문 : 결제완료, 상품준비중 (주문제작/설치 등 일부 상품 제외) - 현금, 상품권 주문 : 주문접수 즉시 취소가 가능한 주문은 위 단계일때 [주문취소] 버튼이 표시되므로, 직접 취소 하실 수 있습니다. 단, 위에 해당되지 않는 단계로 넘어간 주문에 대해서는 1:1 고객상담을 통해 주문취소 신청하실 수 있습니다. ▷ AS신청 AS는 마이페이지에서 직접 신청이 불가합니다. 1:1상담신청 혹은 현대홈쇼핑 고객센터(1600-0000)로 전화 주시어 AS 문의를 남겨 주신다면 안내 도와 드리겠습니다. 주문 진행상태에 따라 신청 가능한 항목은 다음과 같습니다.</p>
					...
					<div class="accordion-item">
						<h3 class="accordion-header order-products" id="flush-heading3">
							<button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapse3" aria-expanded="false" aria-controls="#flush-collapse3">
								<i class="fa-solid fa-q"></i><strong>주문한 상품은 배송 내역은 어디서 확인하나요?</strong>
							</button>
						</h3>
