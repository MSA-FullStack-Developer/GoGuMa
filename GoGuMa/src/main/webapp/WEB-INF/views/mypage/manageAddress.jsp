                   		...
                   		<tr>
							<td style="text-align: center;" colspan="5">
								<div style="margin-top: 50px">
							   	...
							   	<h5 class="no_result" style="margin-top: 0px; margin-bottom: 50px">등록된 기본 배송지가 없습니다.</h5>
					   		</td>
					   	</tr>
		         	</c:if>
                   	...
                   	<c:if test="${addressList.size() < 1}">
							...
							<td style="text-align: center;" colspan="6">
								<div style="margin-top: 50px">
							   	...
							   	<h5 class="no_result" style="margin-top: 0px; margin-bottom: 50px">등록된 배송지가 없습니다.</h5>
					   		</td>
				   		</tr>
         			</c:if>
